...
function Nftoverview() {
    ...
    const loadNftdata = async () => {
        ...
        const url = "https://uv8kd7y3w5.execute-api.ap-northeast-2.amazonaws.com/production/getlatestgamenft"
        ...
        await axios.get(url).then(function (response) {
            ...
            let filteredResult = response.data.body.filter((res)=>{return res.detail === true})
